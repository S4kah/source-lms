...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('course_chapter_lessions', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE course_chapter_lessions MODIFY COLUMN file_type ENUM('video', 'audio', 'doc', 'file', 'pdf', 'html5') NOT NULL");
        });
    }
    ...
    public function down(): void
    {
        Schema::table('course_chapter_lessions', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE course_chapter_lessions MODIFY COLUMN file_type ENUM('video', 'audio', 'doc', 'file', 'pdf') NOT NULL");
        });
    }
};
