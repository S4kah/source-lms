   ...
   <nav class="navbar navbar-expand-lg main_menu main_menu_3">
       <a class="navbar-brand" href="{{ url('/') }}">
           <img src="{{ asset('frontend/assets/images/logo_segaris.png') }}" alt="logo" class="w-50">
       </a>
   ...
   <div class="mobile_menu_area">
       <div class="mobile_menu_area_top">
           <a class="mobile_menu_logo" href="{{ url('/') }}">
               <img src="{{ asset('frontend/assets/images/logo_segaris.png') }}" class="w-50" alt="{{ config('settings.site_title') }}">
           </a>
