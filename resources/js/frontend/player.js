...
function playerHtml(id, source_type, source, file_type) {
    ...
    if (source_type == "youtube") {
        return `<video id="vid1" class="video-js vjs-default-skin" controls autoplay width="640" height="264"
            data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "${source}"}] }'>
        </video>`;
    } else if (source_type == "vimeo") {
        return `<video id="vid1" class="video-js" width="640" height="264"
        ...
        return `<iframe src="${source}" width="640" height="264" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>`;
    } else if (source_type == "html5") {
        return `<iframe src="${base_url}${source}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="width: 100%; height: 500px;"></iframe>`;
    }
}
